...
- 2026-07-17 起，工单管理页的详情全屏弹窗由 `TicketDetailWithList.vue` 自闭环承接，列表页仅传 `ticketId/open` 并监听 `changed/closed`；详情组件内部管理详情数据、描述/AI 翻译、日志拉取、AI 分析、任务历史、仓库映射、问题归因、评论、协同消息、RCA 和日志查看器弹窗。下方内容区拆为概览、日志拉取、协同、评论、历史 5 个 tab 子组件。
