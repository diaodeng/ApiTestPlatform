<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['qtr:job:remove']">
          删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" @click="handleClean" v-hasPermi="['qtr:job:remove']">清空</el-button>
      </el-col>
      <el-col :span="1.5">
...
import { cleanJobLog, delJobLog, listJobLog } from "@/api/qtr/jobLog.js";
...
function handleClose() {
  proxy.$tab.closeOpenPage({ path: "/hrm/qtr/qtr/job" });
}
