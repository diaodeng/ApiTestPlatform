...
import { errorRecords as fetchErrorRecords, errorSummary as fetchErrorSummary } from "@/api/hrm/report.js";
...
<template>
<el-dialog v-model="openErrorSummaryDialog" width="80%">
  <el-card
    ...
    >
      ...
      <el-row :gutter="12" class="error-metric-row">
        ...
        <el-col :xs="24" :sm="8">
          <div class="error-metric error-metric--assert">
            ...
            <el-button link type="danger" @click="openErrorDrawer({ errorType: 'assert_fail' })">查看明细</el-button>
          </div>
        </el-col>
        <el-col :xs="24" :sm="8">
          <div class="error-metric error-metric--exception">
            ...
            <el-button link type="warning" @click="openErrorDrawer({ errorType: 'exception' })">查看明细</el-button>
          </div>
        </el-col>
      </el-row>
      ...
      <el-table
          ...
          max-height="260"
      >
        <el-table-column label="断言失败原因" prop="errorTemplate" min-width="260" show-overflow-tooltip />
  ...
  <el-drawer
    ...
    >
      ...
      <el-table v-loading="loading.errorRecords" :data="errorRecordList" border table-layout="fixed">
        ...
        <el-table-column label="检查项" prop="checkKey" min-width="180" show-overflow-tooltip />
        <el-table-column label="期望值" prop="expectedValue" min-width="180" show-overflow-tooltip />
        <el-table-column label="实际值" prop="actualValue" min-width="180" show-overflow-tooltip />
        <el-table-column label="错误信息" prop="errorMessage" min-width="260" show-overflow-tooltip />
