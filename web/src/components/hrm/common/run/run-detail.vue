  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
      ...
      <el-form-item
        label="用例名称"
        prop="runName"
        v-if="viewType === runDetailViewTypeEnum.report"
      >
        <el-input
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['hrm:report:downloadHtml']"
          >导出HTML</el-button
        >
        <el-button
          v-if="false"
          ...
          v-hasPermi="['hrm:report:downloadPdf']"
          >导出PDF</el-button
        >
      </el-form-item>
    </el-form>
    ...
    >
      ...
      ><el-table-column label="执行方式" align="center" prop="runType" width="110px">
        <template #default="scope">
...
<script setup name="RunDetail">
  ...
  function handleDelete(row) {
    ...
    proxy.$modal
      .confirm('是否确认删除ID为"' + detailIds + '"的数据项？')
      .then(function () {
  ...
  function handleDownloadHtml(row) {
    loading.value.page = true;
    downloadHtml(queryParams.value)
      .then((response) => {
        // 创建下载链接
