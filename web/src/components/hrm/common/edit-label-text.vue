...
<template>
  ...
  <el-input ref="contentEditRef" style="width: auto; padding-right: 5px" v-show="edit" v-model="content" @blur="evt => {edit=false}"></el-input>
  <el-icon :size="15" color="blue" @click="() => {edit=true;contentEditRef.focus()}" v-show="!edit&&showEdite">
    <EditPen/>
  </el-icon>
  <el-icon color="green" :size="15" @click="() => {edit=false}" v-show="edit"><Select/></el-icon>
</template>
