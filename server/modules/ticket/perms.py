...
MENU_DEFS: tuple[MenuConfig, ...] = (
    ...
    F("ticket.message.list", "协同消息查询", "ticket.ticket", "ticket:message:list", 9),
    F("ticket.message.add", "协同消息新增", "ticket.ticket", "ticket:message:add", 10),
    F("ticket.snapshot.add", "ACR快照新增", "ticket.ticket", "ticket:snapshot:add", 11),
    F("ticket.comment.add", "评论新增", "ticket.ticket", "ticket:comment:add", 12),
    F("ticket.event.add", "事件新增", "ticket.ticket", "ticket:event:add", 13),
    F("ticket.rca.edit", "RCA保存", "ticket.ticket", "ticket:rca:edit", 14),
