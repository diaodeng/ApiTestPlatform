...
def _ticket_sort_expression_map(submit_time_expr, latest_log_status, latest_ai_status):
    ...
    return {
        ...
        "issueRelationType": Ticket.issue_relation_type,
        "issue_relation_type": Ticket.issue_relation_type,
        "issueConfirmed": Ticket.issue_confirmed,
        "issue_confirmed": Ticket.issue_confirmed,
        "affectedVersionId": Ticket.affected_version_id,
        "affected_version_id": Ticket.affected_version_id,
        "plannedFixVersionId": Ticket.planned_fix_version_id,
        "planned_fix_version_id": Ticket.planned_fix_version_id,
        "fixedVersionId": Ticket.fixed_version_id,
        "fixed_version_id": Ticket.fixed_version_id,
        "releasedVersionId": Ticket.released_version_id,
    ...
    def get_ticket_list(cls, db: Session, query: TicketQueryModel):
        ...
        ticket_query = (
            ...
            .filter(
                ...
                Ticket.affected_version_id == query.affected_version_id if query.affected_version_id else True,
                Ticket.planned_fix_version_id == query.planned_fix_version_id if query.planned_fix_version_id else True,
                Ticket.fixed_version_id == query.fixed_version_id if query.fixed_version_id else True,
                Ticket.released_version_id == query.released_version_id if query.released_version_id else True,
            )
