...
class DeptDao:
    ...
    @classmethod
    def get_dept_info_for_edit_option(cls, db: Session, dept_info: DeptModel, data_scope_sql: DataScopeExpr):
        """
        获取部门编辑对应的在用部门列表信息
        :param db: orm对象
    ...
    @classmethod
    def get_dept_list_for_tree(cls, db: Session, dept_info: DeptModel, data_scope_sql: DataScopeExpr):
        """
        获取所有在用部门列表信息
        :param db: orm对象
        :param dept_info: 部门对象
    ...
    @classmethod
    def get_dept_list(cls, db: Session, page_object: DeptModel, data_scope_sql: DataScopeExpr):
        """
        根据查询参数获取部门列表信息
        :param db: orm对象
