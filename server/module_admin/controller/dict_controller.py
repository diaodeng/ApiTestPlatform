...
async def get_system_dict_type_list(request: Request,
    ...
    try:
        # 获取分页数据
        dict_type_page_query_result = DictTypeService.get_dict_type_list_services(query_db,
...
async def add_system_dict_type(request: Request,
...
async def edit_system_dict_type(request: Request,
...
async def query_system_dict_type_options(request: Request, query_db: Session = Depends(get_db)):
    try:
        dict_type_query_result = DictTypeService.get_dict_type_list_services(query_db,
                                                                             DictTypePageQueryModel(**{}),
                                                                             is_page=False)
        logger.info('获取成功')
...
@dictController.get("/type/{dict_id}",
...
async def get_system_dict_data_list(request: Request,
    ...
    try:
        # 获取分页数据
        dict_data_page_query_result = DictDataService.get_dict_data_list_services(query_db,
...
@log_decorator(title='字典管理', business_type=1)
async def add_system_dict_data(request: Request,
...
@log_decorator(title='字典管理', business_type=2)
async def edit_system_dict_data(request: Request,
...
@dictController.get("/data/{dict_code}",
...
async def export_system_dict_data_list(request: Request,
    ...
    try:
        # 获取全量数据
        dict_data_query_result = DictDataService.get_dict_data_list_services(query_db,
                                                                             dict_data_page_query,
                                                                             is_page=False)
