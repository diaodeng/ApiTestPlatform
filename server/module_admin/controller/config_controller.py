...
from module_admin.service.config_service import ConfigModel, ConfigPageQueryModel, ConfigService, DeleteConfigModel
...
async def add_system_config(request: Request,
...
async def edit_system_config(request: Request,
