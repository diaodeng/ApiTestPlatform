...
async def add_system_notice(request: Request,
...
async def edit_system_notice(request: Request,
...
@noticeController.delete("/{notice_ids}",
                         dependencies=[Depends(CheckUserInterfaceAuth('system:notice:remove'))])
...
@noticeController.get("/{notice_id}",
