...
class QTRSystemConfig(Base, BaseModel):
    """
    系统配置表
    """
    ...
    __tablename__ = 'qtr_system_config'
    ...
    config_type: Mapped[int] = mapped_column(Integer, nullable=False, comment='配置类型（1系统配置 2自定义配置）')
