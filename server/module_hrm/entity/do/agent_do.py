...
class QtrAgent(Base, BaseModel):
    ...
    agent_id: Mapped[int] = mapped_column(BigInteger, primary_key=True, unique=True, nullable=False,
    ...
    status: Mapped[int] = mapped_column(Integer, nullable=True, default=2, comment='Agent状态（2在线 1离线）')
