    ...
    def nav_rail_menu(self):
        ...
        nav_rail = self.ft.NavigationRail(
            ...
            destinations=[
                ...
                # ),
                self.ft.NavigationRailDestination(
                    icon=self.ft.Icons.SETTINGS_OUTLINED, selected_icon=self.ft.Icons.SETTINGS, label="设置"
                ),
                self.ft.NavigationRailDestination(
                    icon=self.ft.Icons.WAREHOUSE_OUTLINED, selected_icon=self.ft.Icons.WAREHOUSE, label="商品"
                ),
                self.ft.NavigationRailDestination(
                ...
                self.ft.NavigationRailDestination(
                    icon=self.ft.Icons.NEAR_ME_OUTLINED, selected_icon=self.ft.Icons.NEAR_ME_ROUNDED, label="mitmproxy"
                ),
                self.ft.NavigationRailDestination(
                    icon=self.ft.Icons.NEAR_ME_OUTLINED, selected_icon=self.ft.Icons.NEAR_ME_ROUNDED, label="FTP"
                ),
                self.ft.NavigationRailDestination(
                    icon=self.ft.Icons.TERMINAL, selected_icon=self.ft.Icons.TERMINAL, label="日志"
                ),
                self.ft.NavigationRailDestination(
